...
function Case() {
        ...
        const [tenderResponse, evidenceResponse] =
          ...
          await Promise.all([
            ...
            fetch(
              ...
              `${API_URL}/api/tenders/${tenderId}`

            ),

            fetch(

              `${API_URL}/api/tenders/${tenderId}/evidence`
  ...
  const numberOfBidders =
    ...
    tender.numberOfBidders ?? 'Not available'
            ...
            <div className="case-meta">
              ...
              <div>
                ...
                <strong>
                  ...
                  Rs. {estimatedValue.toLocaleString('en-IN')}
              ...
              <div>
                ...
                <strong>
                  ...
                  Rs. {contractValue.toLocaleString('en-IN')}
                ...
                <div className="entity-card primary-entity">
                  ...
                  <div className="entity-detail">
                    ...
                    <strong>
                      ...
                      {tender.winningVendorId || 'Not available'}
