    ...
    const timer = setTimeout(async () => {
      try {
        ...
        const response = await fetch(
          `http://127.0.0.1:8000/api/tenders?${params.toString()}`
        )
        ...
        if (!cancelled) {
          ...
          setTotal(Number(data.total ?? 5000))
        }
      } catch (error) {
      ...
      <main className="tenders-main">
        ...
        <div className="tenders-content">
                ...
                {tenders.map((tender) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span>{tender.winningVendor}</span>

                      <span>{formatValue(tender.contractValue)}</span>
          ...
          <div className="tenders-disclaimer">
            <div className="tenders-disclaimer-icon">i</div>
